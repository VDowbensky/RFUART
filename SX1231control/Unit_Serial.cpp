...
int rf_result;
	...
	rx_stat=ERR_NO_ANS;
	  ...
	  else if (rx_buf[0]!=HI(RXPREFIX)){//TODO add Omnicomm
...
int wf_result;
	...
	LeaveCriticalSection(&critsect);
		...
		tx_buf[0]=HI(TXPREFIX);
		tx_buf[1]=LO(TXPREFIX); //tmp_tx_addr;
		tx_buf[2]=tmp_tx_cmd;
		//if(txcount != 0)
		//{
...
DWORD processcommand(DWORD cmd, DWORD tbytes, DWORD rbytes){
DWORD rx_cmd;
DWORD rx_addr;
DWORD ugen;
DWORD i;
DWORD stat;
  ...
  //..........................
	...
	if ( (rx_addr!=LO(RXPREFIX))||(rx_cmd!=cmd) ){
