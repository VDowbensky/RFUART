...
/**
  ************************************************** ***************************
  ** \brief PCA interrupt flag acquisition
  **
  **
  ** \param [in] enModule PCA module selection (Module0, Module1, Module2, Module3, Module4)
  **
...
/**
  ************************************************** ***************************
  ** \brief PCA count interrupt flag acquisition
  **
  **
  **
  ** \retval TRUE or FALSE
...
/**
  ************************************************** ***************************
  ** \brief PCA interrupt flag clear
  **
  **
  ** \param [in] enModule PCA module selection (Module0, Module1, Module2, Module3, Module4)
  **
...
/**
  ************************************************** ***************************
  ** \brief PCA count interrupt flag clear
  **
  **
  **
  ** \retval Ok or Error
...
/**
  ************************************************** ***************************
  ** \brief PCA count interrupt enable
  **
  **
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief PCA count interrupt disabled
  **
  **
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief PCA Initial Configuration
  **
  **
  ** \param [in] pstcConfig PCA module configuration structure pointer
  **
  ** \retval Ok or Error
  ************************************************** ***************************/
...
/**
  ************************************************** ***************************
  ** \brief PCA mode configuration
  **
  **
  ** \param [in] enModule PCA module selection (Module0, Module1, Module2, Module3, Module4)
  ** \param [in] pstcCapMod PCA mode configuration structure pointer
  **
  ** \retval Ok or Error
  ************************************************** ***************************/
...
/**
  ************************************************** ***************************
  ** \brief PCA16 bit comparison data setting
  **
  **
  ** \param [in] enModule PCA module selection (Module0, Module1, Module2, Module3, Module4)
  ** \param [in] u16Data PCA capture data
  **
  ** \retval Ok or Error
  ************************************************** ***************************/
...
/**
  ************************************************** ***************************
  ** \brief PCA16 bit capture data acquisition
  **
  **
  ** \param [in] enModule PCA module selection (Module0, Module1, Module2, Module3, Module4)
  **
...
/**
  ************************************************** ***************************
  ** \brief PCA high 8-bit comparison data setting
  **
  **
  ** \param [in] enModule PCA module selection (Module0, Module1, Module2, Module3, Module4)
  ** \param [in] u8Data PCA high 8 bit capture data
  **
  ** \retval Ok or Error
  ************************************************** ***************************/
...
/**
  ************************************************** ***************************
  ** \brief PCA low 8-bit comparison data setting
  **
  **
  ** \param [in] enModule PCA module selection (Module0, Module1, Module2, Module3, Module4)
  ** \param [in] u8Data PCA low 8 bit capture data
  **
  ** \retval Ok or Error
  ************************************************** ***************************/
...
/**
  ************************************************** ***************************
  ** \brief PCA counter initial value setting
  **
  **
  **
  ** \param [in] u16Data PCA counter initial value
  **
  ** \retval Ok or Error
  ************************************************** ***************************/
...
/**
  ************************************************** ***************************
  ** \brief PCA16 bit counter value acquisition
  **
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief PCA cycle reload value setting
  **
  **
  **
  ** \param [in] u16Data PCA cycle reload value
  **
  ** \retval Ok or Error
  ************************************************** ***************************/
...
/**
  ************************************************** ***************************
  ** \brief PCA cycle reload value acquisition
  **
  **
  **
  ** \retval PCA cycle reload value
  ************************************************** ***************************/
...
/**
  ************************************************** ***************************
  ** \brief PCA Enhanced PWM disable
  **
  **
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief PCA compares high speed output flag acquisition
  **
  **
  ** \param [in] enModule PCA module selection (Module0, Module1, Module2, Module3, Module4)
  **
