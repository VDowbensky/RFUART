...
/**
  ************************************************** ***************************
  ** \brief Trim interrupt flag gets
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief Trim interrupt flag clear
  **
  **
  ** \param [in] enIntType interrupt type (RefStop, CalCntOf, XTAL32KFault, XTAL32MFault)
  **
...
/**
  ************************************************** ***************************
  ** \brief Trim interrupt service function
  **
  **
  ** \param [in] u8Param == 0
  **
...
/**
  ************************************************** ***************************
  ** \brief Trim Initial Configuration
  **
  **
  ** \param [in] pstcConfig Trim configuration structure pointer
  **
  ** \retval Ok or Error
  ************************************************** ***************************/
...
/**
  ************************************************** ***************************
  ** \brief Trim calibration / monitoring start up
  **
  **
  **
  ** \retval Ok or Error
...
/**
  ************************************************** ***************************
  ** \brief Trim calibration counter count value acquisition
  **
  **
  **
  **
  ** \retval u32Data calibration counter count value
  ************************************************** ***************************/
