...
  ** \brief SPI request status acquisition
  **
  ** \param [in]enCh channel, enStatus get request
  **
  ** \retval request status
  **
  ************************************************** ****************************/
...
/**
  ************************************************** ****************************
  ** \brief SPI function enable disable function
  **
  ** \param [in] enCh channel, enFunc function, bFlag 0/1 enabled or disabled
  **
...
  ** \param [in]
             enCh channel
             pstcSpiConfig initialization structure
  **
  ** \retval Ok initialized successfully
  ** \retval ErrorInvalidParameter initialization error
  ************************************************** ****************************/
...
/**
  ************************************************** ****************************
  ** \brief SPI configures the level of the main send
  **
  ** \param [in] High and low level
  **
  ** \retval none
  **
  ************************************************** ****************************/
...
/**
  ************************************************** ****************************
  ** \brief SPI sends a one-byte function
  **
  ** \param [in] enCh channel, u8Data send byte
  **
...
/**
  ************************************************** ****************************
  ** \brief SPI receives a one-byte function
  **
  ** \param [in] enCh receiving channel
  **
  ** \retval receives one byte of data
  **
  ************************************************** ****************************/
