...
  *
  * \param [in] en_opa_channel_t OPA using that channel
  * \param [in] en_opa_modesel_t OPA mode selection
   * \param [in] stc_opa_gain_config_t OPA gain selection
  *
  * \retval none
  */
...
/**
  * \brief
  * OPA basic function settings (cascading forward and reverse modes and meter mode)
  * \param [in] en_opa_modesel_t OPA mode selection
   * \param [in] stc_opa_gain_config_t OPA gain selection
  *
  * \retval none
...
  * \brief
  * OPA meter mode
   * \param [in] en_opa_metergain_t OPA gain selection
  *
  * \retval none
  */
...
  * \brief
  * OPA correction mode
   * \param [in] en_opa_calsel_t OPA correction mode selection
  *
  * \retval none
  */
