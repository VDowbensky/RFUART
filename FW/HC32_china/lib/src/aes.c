 ...
 *          AES encrypt
 *
 * \param   [in]   pu32Data    Data to be encrypted
 * \param   [in]   pu32Key     Encryption KEY
 * \param   [out]  pu32Cipher  Encrypted data
 *
 ...
 *          AES decrypt
 *
 * \param   [in]   pu32Cipher  Data to be decrypted
 * \param   [in]   pu32Key     Encryption KEY
 * \param   [out]  pu32Data    Decrypted data
 *
 * \retval  en_result_t  Ok:  Success
 * \retval  en_result_t  ErrorInvalidParameter: Invalid parameter
 */
