...
/**
  ************************************************** ****************************
  ** \brief I2C set baud rate configuration register
  **
...
/**
  ************************************************** ****************************
  ** \brief I2C function setting related function
  **
  ** \param [in] enFunc function parameter
  **
  ** \retval enRet success or failure
  **
  ************************************************** ****************************/
...
/**
  ************************************************** ****************************
  ** \brief I2C function clear related function
  **
  ** \param [in] enFunc function parameter
  **
  ** \retval enRet success or failure
...
/**
  ************************************************** ****************************
  ** \brief I2C gets interrupt flag function
  **
  ** \param no
  **
...
/**
  ************************************************** ****************************
  ** \brief I2C gets relevant status
  **
  ** \param no
  **
  ** \retval I2C status
...
/**
  ************************************************** ****************************
  ** \brief I2C write slave address function
  **
  ** \param u8SlaveAddr slave address
  **
  ** \retval I2C write success or failure status
  **
  ************************************************** ****************************/
...
/**
  ************************************************** ****************************
  ** \brief byte write slave function
  **
  ** \param u8Data write data
  **
  ** \retval write data is successful
  **
  ************************************************** ****************************/
...
/**
  ************************************************** ****************************
  ** \brief byte read slave function
  **
  ** \param no
  **
  ** \retval read data
...
  **
  ** \param u8Addr slave memory address, pu8Data write data, u32Len write data length
  **
  ** \retval write data is successful
  **
  ************************************************** ****************************/
	...
	while(1)
	{
		...
		switch(u8State)
		{
			case 0x08:
				...
				I2C_WriteByte(enCh,u8DevAddr);//Send address
				break;
			case 0x18:
				I2C_WriteByte(enCh,u8Addr);//Send mem. address - ???
				break;
			case 0x28:	
		...
		if(u8i>u32Len)
		{
			I2C_SetFunc(enCh,I2cStop_En);//This order cannot be exchanged, and the stop condition
			I2C_ClearIrq(enCh);
			break;
		}
		I2C_ClearIrq(enCh);			
...
/**
  ************************************************** ****************************
  ** \brief slave send function
  **
  ** \param pu8Data send data cache, u32Len send data length
  **
  ** \retval Is the data sent successfully?
  **
  ************************************************** ****************************/
...
/**
  ************************************************** ****************************
  ** \brief slave receive function
  **
  ** \param pu8Data receive data storage cache, u32Len receive data pointer
  **
  ** \retval Receive data successfully
  **
  ************************************************** ****************************/
...
/**
  ************************************************** ****************************
  ** \brief host receive function
  **
  ** \param u8Addr slave memory address, pu8Data read data storage cache, u32Len read data length
  **
  ** \retval read data is successful
  **
  ************************************************** ****************************/
 en_result_t I2C_MasterReadData(en_i2c_channel_t enCh,uint8_t u8DevAddr,uint8_t *pu8Data,uint8_t u8Addr,uint32_t u32Len)
{
	...
	while(1)
	{
		...
		switch(u8State)
		{
			...
			case 0x10:
				I2C_ClearFunc(enCh,I2cStart_En);
				I2C_WriteByte(enCh,u8DevAddr|0x01);//Send the slave address OK
				break;
			case 0x40:
				if(u32Len>1)
				{
			...
			case 0x48:
				...
				break;
			default:
				I2C_SetFunc(enCh,I2cStart_En);//Other error status, resend start condition
				break;
		}
		I2C_ClearIrq(enCh);
		if(u8i==u32Len)
...
/**
  ************************************************** ****************************
  ** \brief I2C module shutdown initialization
  **
  ** \param no
  **
  ** \retval setting is successful
  **
  ************************************************** ****************************/
...
/**
  ************************************************** ****************************
  ** \brief I2C module interrupt handler
  **
  ** \param u8Param meaningless
  **
  ** \retval none
  **
  ************************************************** ****************************/
