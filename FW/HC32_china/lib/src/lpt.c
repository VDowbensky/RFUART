...
/**
  ************************************************** ***************************
  ** \brief Low Power Timer interrupt flag acquisition
  **
  **
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief Low Power Timer interrupt flag clear
  **
  **
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief Low Power Timer interrupt service function
  **
  **
  ** \param [in] u8Param == 0
  **
...
/**
  ************************************************** ***************************
  ** \brief Low Power Timer Interrupt Enable
  **
  **
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief Low Power Timer interrupt disable
  **
  **
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief Low Power Timer Initial Configuration
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief Low Power Timer starts running
  **
  **
  **
  ** \retval Ok or Error
...
/**
  ************************************************** ***************************
  ** \brief Low Power Timer stops running
  **
  **
  **
  ** \retval Ok or Error
...
/**
  ************************************************** ***************************
  ** \brief Low Power Timer reload value setting
  **
  **
...
/**
  ************************************************** ***************************
  ** \brief Low Power Timer 16-bit count value acquisition
  **
  **
  **
