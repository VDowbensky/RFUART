...
/**
  * \brief
  * LVD interrupt service program
  *
  * \param [in] u8Param not used
  *
  * \retval none
  */
...
  * LVD initialization
  *
  * \param [in] pstcConfig LVD configuration pointer
  *
  * \retval none
  */
...
  * \param none
  *
  * \retval boolean_t Fliter result
  */
