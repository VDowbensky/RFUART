...
typedef enum
{
    ResetUart0   = 0x00000001u,             ///< Serial port 0
    ResetUart1   = 0x00000002u,             ///< Serial port 1
    ResetLpUart0 = 0x00000004u,             ///< Low power serial port 0
    ResetLpUart1 = 0x00000008u,             ///< Low power serial port 1
...
/**
************************************************** *****************************
  ** \brief reset source (identification) display
  **
  ** \note
  ************************************************** ****************************/
typedef struct
...
///< Peripheral module reset control
