...
/** \file flash.h
 **
 ** FLASH Data structure and API declaration.
 **
 ** - 2017-05-02 LuX V1.0
 **
 ******************************************************************************/
...
{
    FlashPCInt    = 1u,          ///<Erase PC address alarm interrupt
    FlashSlockInt = 0u,          ///<Erase protection alarm interrupt
} en_flash_int_type_t;


/**
 ******************************************************************************
  ** \brief Flash read wait period type definition
 *****************************************************************************/
typedef enum en_flash_waitcycle
{
    FlashWaitCycle0 = 0u,       ///< Read wait period is set to 0 (when HCLK is less than or equal to 24MHz)
    FlashWaitCycle1 = 1u,       ///< Read wait period is set to 1 (must be at least 1 when HCLK is greater than 24MHz)
    FlashWaitCycle2 = 2u,       ///< The read wait period is set to 2 (must be at least 2 when HCK is greater than 48MHz)
} en_flash_waitcycle_t;

/**
 ******************************************************************************
  ** \brief Flash erasing protection scope definition
 *****************************************************************************/
 ...
 ******************************************************************************/
///<Flash Initial configuration (interrupt function, programming time parameter, and sleep mode configuration)
en_result_t Flash_Init(func_ptr_t pfnFlashCb, uint8_t u8FreqCfg, boolean_t bDpstbEn);

///<Flash Page/full chip erase
