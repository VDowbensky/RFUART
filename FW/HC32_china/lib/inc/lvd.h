...
/**
 ******************************************************************************
 ** \brief LVD input voltage source
 **
 ** \note
 ******************************************************************************/
...
/**
 ******************************************************************************
 ** \brief LVD monitoring voltage selection
 **
 ** \note
 ******************************************************************************/
typedef enum en_lvd_threshold
{
    ...
    LvdTH2p4V = 6u,                  ///< 2.4V
    LvdTH2p5V = 7u,                  ///< 2.5V
    LvdTH2p6V = 8u,                  ///< 2.6V Default voltage
    LvdTH2p7V = 9u,                  ///< 2.7V
    LvdTH2p8V = 10u,                  ///< 2.8V
    LvdTH2p9V = 11u,                  ///< 2.9V
    LvdTH3p0V = 12u,                  ///< 3.0V
...
/**
 ******************************************************************************
 ** \brief LVD output filtering time
 **
 ** \note
 ******************************************************************************/
...
{
    LvdIrqHigh  = 0u,                 ///< High level trigger
    LvdIrqRise  = 1u,                 ///< Rising edge trigger
    LvdIrqFall  = 2u,                 ///< Falling edge trigger
}en_lvd_irq_type_t;
...
{
    boolean_t               bLvdReset;      ///< TRUE-restart, FALSE-interrupt
    en_lvd_input_t          enInput;        ///< LVD input voltage source
    en_lvd_threshold_t      enThreshold;    ///< LVD monitoring voltage
    boolean_t               bFilter;        ///< Whether to use output filtering
    en_lvd_filter_time_t    enFilterTime;   ///< Output filtering time
    en_lvd_irq_type_t       enIrqType;      ///< Interrupt trigger mode
