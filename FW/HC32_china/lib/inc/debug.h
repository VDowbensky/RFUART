...
/**
 *******************************************************************************
 ** \brief Working mode type definition of each module in debug mode
 ** \note
 ******************************************************************************/
 ...
 ******************************************************************************/
///< Enable module function in SWD debugging interface
en_result_t Debug_ActiveEnable(en_debug_module_active_t enModule);
///< Disable module function in SWD debugging interface
